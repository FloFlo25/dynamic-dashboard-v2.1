...
const AuthLayout = ({ children }: Props) => {
	return (
		...
		>
			<div className="flex flex-col justify-start gap-[48px] items-center bg-[#94949457] bg-opacity-25 backdrop-blur-sm rounded-none drop-shadow-lg sm:m-7 px-14 py-16 h-full w-full sm:px-20 sm:rounded sm:w-[500px]">
				<DynamicLogo />
				{children}
			</div>
		</div>
